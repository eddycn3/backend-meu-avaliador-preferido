...
var Avaliador = /** @class */ (function () {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        error_1 = _a.sent();
                        console.log("Avaliador.create", error_1);
                        avaliador = undefined;
                        return [3 /*break*/, 3];
                    case 3: return [2 /*return*/, avaliador];
                }
            });
        });
    };
    Avaliador.prototype.getByID = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var avaliador;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, connection_1.default("avaliadores").where("id", id).first()];
                    case 1:
                        avaliador = _a.sent();
                        if (!avaliador) {
    ...
    Avaliador.prototype.getByUserID = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            var avaliador;
            return __generator(this, function (_a) {
                switch (_a.label) {
