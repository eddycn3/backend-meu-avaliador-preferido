...
var Usuario = /** @class */ (function () {
    ...
    Usuario.prototype.authUsuario = function (user, pass) {
        return __awaiter(this, void 0, void 0, function () {
            var userDB, match;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (!userDB)
                            return [2 /*return*/, 0];
                        return [4 /*yield*/, bcrypt.compare(pass, userDB === null || userDB === void 0 ? void 0 : userDB.password)];
                    case 2:
                        match = _a.sent();
                        if (match) {
                            return [2 /*return*/, +userDB.id];
                        }
                        return [2 /*return*/, 0];
                }
            });
    ...
    Usuario.prototype.getByID = function (id) {
