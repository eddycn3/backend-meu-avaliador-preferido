...
var AuthController = /** @class */ (function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        ...
                        if (usuario.ativo === 0) {
                            return [2 /*return*/, response.status(409).json({ error: "Usuário esta inativo" })];
                        }
                    ...
                    case 4:
                        err_1 = _b.sent();
                        next(new HttpException_1.default(404, "Erro na autenticação do usuario", err_1.message));
                        return [3 /*break*/, 5];
    ...
    AuthController.prototype.authenticate = function (request, response, next) {
        return __awaiter(this, void 0, void 0, function () {
            var _a, user_name, password, userId, err_2;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _b.trys.push([0, 2, , 3]);
                        _a = request.body, user_name = _a.user_name, password = _a.password;
                    ...
                    case 1:
                        ...
                        return [2 /*return*/, response.json({ id: userId })];
                    case 2:
                        err_2 = _b.sent();
