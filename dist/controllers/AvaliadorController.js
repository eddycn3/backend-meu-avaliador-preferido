...
var AvaliadorController = /** @class */ (function () {
    ...
    AvaliadorController.prototype.index = function (request, response) {
    ...
    AvaliadorController.prototype.create = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var avaliador;
            return __generator(this, function (_a) {
                avaliador = new Avaliador_1.default().create(request.body);
                if (avaliador) {
                    return [2 /*return*/, response.status(409).json({ error: "registro já existente!" })];
                }
                return [2 /*return*/, response.json(avaliador)];
            });
        });
    };
    return AvaliadorController;
}());
